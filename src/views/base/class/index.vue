<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="classList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" prop="classId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="分类编码" prop="classCode">
          <el-input v-model="form.classCode" placeholder="请输入分类编码" :disabled="form.classId != null" />
        </el-form-item>
        <el-form-item label="分类名称" prop="className">
...
<script>
import { listClass, getClass, delClass, addClass, updateClass } from "@/api/base/class";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除物料分类编号为"' + classIds + '"的数据项？').then(function() {
